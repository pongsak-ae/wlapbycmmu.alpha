                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                        ...
                        <div class="d-sm-none w-100">
                            <div class="row mt-3">
                                ...
                                <div class="col-8">
                                    <a class="btn d-block th" href="#" style="float: right;">สมัคร W-ALP #2</a>
                                </div>
                            </div>
                        </div>
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            ...
                            <div class="ml-auto">
                                <a class="btn th" href="#">สมัคร W-ALP #2</a>
                            </div>
                        </div>
                    </nav>
                </div>
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/W-LAP-1.jpg" alt="Carousel Image">
                        <div class="carousel-caption slide-text">
                            ...
                            <a class="btn animated fadeInUp th" href="#">สมัคร W-ALP #2</a>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="img/W-LAP-2.jpg" alt="Carousel Image">
                        <div class="carousel-caption slide-text">
                            <p class="animated fadeInRight mt-text-slide">Fast tracking you to become a Professional Leader</p>
                            <h1 class="animated fadeInLeft" style="text-shadow: 0 0 10px #fff;">W-LAP</h1>
                            <a class="btn animated fadeInUp th" href="#">สมัคร W-ALP #2</a>
                    ...
                    <div class="carousel-item">
                        <img src="img/W-LAP-3.jpg" alt="Carousel Image">
                        <div class="carousel-caption slide-text">
                            <p class="animated fadeInRight mt-text-slide">Fast tracking you to become a Professional Leader</p>
                            <h1 class="animated fadeInLeft" style="text-shadow: 0 0 10px #fff;">W-LAP</h1>
                            <a class="btn animated fadeInUp th" href="#">สมัคร W-ALP #2</a>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="team-item">
                                ...
                                <div class="team-text">
                                    <h2 class="th">ปฏิญญา เกี่ยวข้อง</h2>
                                    <p class="font-12">Managing Director and Creative Director N-ten Venture Group Digital Curator L’Officiel Thailand</p>
                                </div>
                                <div class="team-social">
                                    <a class="social-li" >STAGE 1</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="img/speaker2.jpg" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2 class="th">เพชรพริ้ง สารสิน</h2>
                                    <p class="th font-12">ผู้เชียวชาญด้านภาพลักษณ์และสื่อสารองค์กร</p>
                                </div>
                                <div class="team-social">
                                    <a class="social-li" >STAGE 1</a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="img/speaker3.jpeg" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2 class="th">ผศ.ดร.กรรณิการ์ ลีลาปัญญาเลิศ</h2>
                                    <p class="th font-12">ผู้เชียวชาญด้านทักษะการสือสาร</p>
                                </div>
                                <div class="team-social">
                                    <a class="social-li" >STAGE 1</a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="img/speaker4.JPG" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2 class="th">กัปตัน ศศิทัต กุลทรัพย์ตระกูล</h2>
                                    <p class="th font-12">กัปตันประจำเครืองบินแบบ AIRBUS 330-300</p>
                                </div>
                                <div class="team-social">
                                    <a class="social-li" >STAGE 1</a>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 wow fadeInUp mt-3" data-wow-delay="0.2s">
                            ...
                            <p class="th text-white font-13">
                                วันที่ 3 กันยายน - 3 ธันวาคม 2564<br>
                                ทุกวันศุกร์ รวม 14 สัปดาห์<br>
                                เวลา 14.00 - 18.00 น.<br>
                                กิจกรรมสัมพันธ์เวลา 18.00 - 22.00 น.<br>
                                อบรมที่โรมแรม Lancaster Bangkok ถ.เพชรบุรีตัดใหม่ กรุงเทพมหานคร
                            </p>
                            <p class="th text-white font-20 mb-0" style="color: #fdbe33 !important;">
                            ...
                            <center class="my-5"><a class="regis-btn animated fadeInUp th" href="#">สมัคร W-ALP #2</a></center>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="testimonial-slider-nav">
                                <div class="slider-nav"><img src="img/review1.JPG" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="img/review2.JPG" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="img/review3.JPG" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="img/review4.JPG" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="img/review5.JPG" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="img/review6.JPG" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="img/review7.JPG" alt="Testimonial"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="testimonial-slider">
                                <div class="slider-item">
                                    <h3 class="th">ปกฉัตร โลหะพันธ์สมบูรณ์</h3>
                                    <h4 class="th">ธุรกิจส่วนตัวโรงแรมร้านอาหาร</h4>
                                    <p class="th text-aura">สอนให้ผู้บริหารดึงศักยภาพย์ออกมาให้ลูกน้องทำงานได้ดีขึ้น เพื่อนมีคุณภาพน่ารัก เรียนก็สนุก ปาร์ตี้ก็สนุก เพื่อนก็ดีความรู้ก็แน่นค่ะ.</p>
                                </div>
                                <div class="slider-item">
                                    <h3 class="th">วิริยะ เตชารุ่งโรจย์</h3>
                                    <h4 class="th">รองศาสตราจารย์สาขาการตลาด มหาวิทยาลัยนานาชาติมหิดล </h4>
                                    <p class="th text-aura">หลักสูตรนี้พร้อมที่จะทำให้คุณมีความสามารถในด้าน Leadership skill มากยิงขึ้นจากผู้เชียวชาญหลากหลายสาขาและผู้ที่มาร่วมเรียนด้วยกัน หลักสูตรนี้จะทำให้คุณเห็นว่า Leader ที่แท้จริงเป็นอย่างไร.</p>
                                </div>
                                <div class="slider-item">
                                    <h3 class="th">เดิมพันธ์ อยู่วิทยา</h3>
                                    <h4 class="th">ผู้บริหาร Ribbit Capital & Lima Coco Resort Group</h4>
                                    <p class="th text-aura">ทีแรกเราคิดว่าเราเป็นผู้บริหารมานานทำงานมานาน หลังจากมาเรียน มันทำให้เรารู้ว่ามันมีองค์ความรู้ที่เราสามารถเอาไปพัฒนาธุรกิจของเราได้เยอะมากๆ
                                    ผมได้นำความรู้ที่ได้มาเอาไปวางรากฐานของธุรกิจใหม่ทั้งหมดแล้วมันก็เกิดประสิทธิภาพที่ดี ลดปัญหา ลดต้นทุน และจัดการงานได้ดีขึ้น.</p>
                                </div>
                                <div class="slider-item">
                                    <h3 class="th">วรยุทธ กิตติอุดม</h3>
                                    <h4 class="th">CEO บริษัทรุ่งกิจเรียลเอสเตทจำกัด </h4>
                                    <p class="th text-aura">หลักสูตรนี้ประทับใจกว่าหลักสูตรที่เคยไปเรียนมา ครบเรื่อง เนื้อหา ความรู้ Conection ได้เพื่อนแท้ได้เพื่อนที่จริงใจจากหลักสูตรนี้ด้วย การมาเรียนที่นี้คุ้มค่ามาก เพราะเราได้อะไรหลายๆอย่างมาเติมเต็มสิ่งที่เรายังขาดหายไปอยุ่.</p>
                                </div>
                                <div class="slider-item">
                                    <h3 class="th">คุณเปิ้ล</h3>
                                    <h4 class="th">เจ้าของกิจการ</h4>
                                    <p class="th text-aura">ประทับใจเพื่อนร่วมคลาสทุกคนน่ารัก และได้พาร์ทเนอร์เพิ่มเติมในการทำธุรกิจมาด้วย และความรู้ที่ได้เกินความคาดหวังไว้ คลาสนี้ไม่ได้เป็นแค่การให้ความรู้แค่อย่างเดียว ยังให้การพัฒนาบุคลิกภาพอีกด้วย ถือว่าครบในการเป็น professional ค่าใช้จ่ายของค่าคอร์สที่เสียไปเรียกได้ว่าคุ้มค่ามากๆค่ะ.</p>
                                </div>
                                <div class="slider-item">
                                    <h3 class="th">โน้ต อภิสิทธิ์ อภิปัญญา</h3>
                                    <h4 class="th">ผู้จำหน่ายรถยนต์สาขาสาธร ฮอนด้าคาร์ส์จำกัด</h4>
                                    <p class="th text-aura">ได้มีโอกาสพบกับเพื่อนในคอร์ส แตกต่างกันในแต่ละด้านและได้มาแลกเปลี่ยนประสบการณ์กัน เป็นประโยชน์อย่างมากในด้านธุรกิจของเรา</p>
                                </div>
                                <div class="slider-item">
                                    <h3 class="th">พชรพล วิทย์ประยูร </h3>
                                    <h4 class="th">นักบินของสายการบินไทย</h4>
                                    <p class="th text-aura">เขาสอนให้เรารู้ในหลายๆด้านและเริ่มจากตัวเราเองก่อน ในการปรับใช้ในชีวิตประจำวันของเราก่อนแล้วค่อยเอาไปปรับในองค์กรของเราได้ สามารถนำความรู้แนวทางมาใช้ปรับในชีวิตประจำวันได้ คอร์สนี้ มันให้อะไรมากว่าที่เราคิดว่าจำได้ด้วยซ้ำ.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <a class="regis-btn animated fadeInUp th" href="#">สมัคร W-ALP #2</a>
